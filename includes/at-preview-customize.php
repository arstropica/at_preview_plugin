<?php
    /**
    * ArsTropica Responsive Framework at-preview-customize.php
    * 
    * PHP version 5
    * 
    ...
    */
    ...
    while (! file_exists('wp-admin') )
        chdir('..'); 

    require_once( 'wp-admin/admin.php' );

    // require_once( 'at-preview-adminfuncs.php' );
...
<body class="at-guest-preview <?php echo esc_attr( $body_class ); ?>">
        ...
        <form id="customize-controls" class="wrap wp-full-overlay-sidebar">
            ...
            <div class="wp-full-overlay-sidebar-content accordion-container" tabindex="-1">
                <div id="customize-info" class="accordion-section <?php if ( $cannot_expand ) echo ' cannot-expand'; ?>">
                    <div id="header-collapse-sidebar" class="accordion-section-title" aria-label="<?php esc_attr_e( 'Collapse Sidebar' ); ?>" tabindex="0">
                        <a href="#" class="collapse-sidebar button-secondary" title="<?php esc_attr_e('Collapse Sidebar'); ?>">
                            <span class="collapse-sidebar-arrow"></span>
                            <span class="collapse-sidebar-label"><?php _e('Collapse'); ?></span>
                        </a>
                    </div>
                    <div class="accordion-section-title" aria-label="<?php esc_attr_e( 'Theme Customizer Options' ); ?>" tabindex="1">
                ...
                <div id="customize-theme-controls"><ul>
                        ...
                        ?>
                    </ul></div><span style="background: #f2f2f2;-moz-box-shadow: inset 5px 5px 5px #000;-webkit-box-shadow: 5px 5px 5px #000; box-shadow: inset 0 0 5px #ccc; border: 1px solid #fff; -moz-border-radius: 4px; -webkit-border-radius: 4px; border-radius: 4px; color: #777; display: block; font-size: 12px; margin: 10px; padding: 10px; ">Customizer Preview by <a href="http://arstropica.com/">ArsTropica</a></span>
            </div>
